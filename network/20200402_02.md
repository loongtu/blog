...
## 2. 测试
openssl测试环境的搭建参见：[centos下搭建openssl测试环境](https://github.com/bertramcheng/blog/blob/master/network/20200402_01.md)。
...
### 2.4 客户端发起连接，指定错误servername
当servername错误时，会有warning：`SSL3 alert read:warning:unrecognized name`
```shell
